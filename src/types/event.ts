...
export interface ClubEvent {
  ...
  venue: string;
  summary: string;
  /** Null when the backend has no attendance estimate. */
  attendeesExpected: number | null;
  /** Null when the backend has no crew size. */
...
/** Minimal event used in lists and the application shell's event context. */
export interface ListEvent {
  ...
  taskCount: number | null;
  volunteerCount: number | null;
  /** Null when the backend has no attendance estimate yet. */
  attendeesExpected: number | null;
  /** Null when the backend has no crew size yet. */
  teamSize: number | null;
}
